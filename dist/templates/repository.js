...
exports.getPrismaRepoTemplate = exports.getInterfaceTemplate = exports.capitalize = void 0;
const capitalize = (str) => str.charAt(0).toUpperCase() + str.slice(1);
exports.capitalize = capitalize;
const getInterfaceTemplate = (name) => {
    const PascalName = (0, exports.capitalize)(name);
...
exports.getInterfaceTemplate = getInterfaceTemplate;
const getPrismaRepoTemplate = (name) => {
    const PascalName = (0, exports.capitalize)(name);
...
exports.getPrismaRepoTemplate = getPrismaRepoTemplate;
